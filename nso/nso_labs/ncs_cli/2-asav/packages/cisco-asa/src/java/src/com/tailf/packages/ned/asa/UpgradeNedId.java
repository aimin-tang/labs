...
public class UpgradeNedId {
    ...
    static private final int OLD_ASA_NS_HASH = 2025688643;
    static private final int OLD_ASA_HASH = 1917820038;
    public UpgradeNedId() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConfIdentityRef newid =
            new ConfIdentityRef("http://cisco.com/ned/asa-id", "cisco-asa");
        ...
        for(int i = 0; i < no; i++) {
            ...
            if (id != null && id.getNSHash() == OLD_ASA_NS_HASH &&
                id.getTagHash() == OLD_ASA_HASH) {
