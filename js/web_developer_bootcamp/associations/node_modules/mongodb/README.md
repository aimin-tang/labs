...
Create a new **embedding.js** file and add the following code to try out some basic CRUD
...
Add to **embedding.js** the following function which uses the **insertMany**
...
Run the updated **embedding.js** file:
